      ...
      <LinearGradient colors={colors.gradient} style={styles.header}>
        ...
        {isActiveSubscription && currentProduct && (
          <View style={styles.activeStatus}>
            ...
            <Text style={styles.activeText}>{currentProduct.name} - Active</Text>
          </View>
        )}
      </LinearGradient>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.plansList}>
            {stripeProducts.map((product) => (
              <View
                key={product.id}
                style={[styles.planCard, product.popular && styles.popularPlan]}
              >
                {product.popular && (
                ...
                >
                  {checkoutLoading === product.priceId ? (
                    <ActivityIndicator
                      size="small"
                      color={product.popular ? colors.background : colors.primary}
                    />
                  ) : (
                    <Text
                      style={[
